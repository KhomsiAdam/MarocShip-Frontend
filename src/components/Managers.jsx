...
function Managers() {
  return (
    <section>
      <div className="bg-gray-7000 w-full h-screen overflow-y-auto users">
                  ...
                  <Form className="flex flex-col gap-4 card bg-base-200 p-4 m-4 min-w-[350px] rounded-md">
                    ...
                    <div className="modal-action">
                      <button type="submit" className="btn bg-green-600">
                        <label htmlFor="manager-modal">Confirm</label>
                      </button>
                      <label
                        htmlFor="manager-modal"
